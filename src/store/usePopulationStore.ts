...
export const usePopulationStore = create<PopulationStore>((set, get) => ({
  ...
  calculateCalorieEquilibrium: () => {
    ...
    // For equilibrium calculation, we assume all workers consume the same amount
    // This is because we're calculating how many people could be sustained if they were all regular workers
    ...
    logger.log(`Calorie equilibrium: ${roundedEquilibrium} (food production: ${foodProduction}, calories: ${totalCaloriesPerDay})`);
